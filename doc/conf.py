...
# -*- coding: utf-8 -*-
#
# Reynir documentation build configuration file, created by
...
latex_documents = [
    (master_doc, "Reynir.tex", "Reynir Documentation", u"Miðeind ehf.", "manual")
]
...
man_pages = [(master_doc, "reynir", "Reynir Documentation", [author], 1)]
