...
from typing import (
    ...
    Dict, List, Tuple, NamedTuple, Type, cast
)
import time
import operator
import json
...
from .bintokenizer import (
    tokenize as bin_tokenize, TokenList, tokens_are_foreign, StringIterable, load_token
)
...
class _Job:
    ...
    def parse(self, tokens: TokenList) -> Tuple[Any, int, int]:
        ...
        try:
            ...
            if (
                not self.parse_foreign_sentences
                and tokens_are_foreign(tokens, min_icelandic_ratio=ICELANDIC_RATIO)
            ):
